      ...
      <div class="head_right">
        <div class="head_right_left">
          <el-menu :default-active="activeIndexHorizontal" @select="menuHandleSelect" mode="horizontal"
            ...
            <el-menu-item v-for="(item,index) in mainMenu" :key="item.ID" :index="index.toString()"
...
<!--                    <i v-html="menu.Icon"></i> 二级菜单图标-->
                ...
                <el-menu-item index="/table"  router>门店列表</el-menu-item>
                <el-menu-item index="/userPersonMap"  router>树形菜单</el-menu-item>
                <el-menu-item index="/moduleTree"  router>模块树</el-menu-item>
              </el-menu>
            </el-scrollbar>
          </div>
        </el-menu>
...
export default {
  ...
  computed: {
    options() {
      console.log('options',this.$store.state.options)
