<template>
        <div class="error-page" :style="`height:${clientHeight}px;`">
                    ...
                    <div class="error-page-main">
                        ...
                        <div class="error-page-actions">
                            ...
                            <div>
                                <h4>可以尝试：</h4>
                                <ol>
                                    <li><a href="javascript:void(0)" @click="back">返回</a></li>
                                    <li><a href="javascript:void(0)" @click="relogin">重新登录</a></li>
                                    <li><a href="#">留言反馈</a></li>
                                </ol>
                            </div>
                        </div>
...
.error-page{background:#f0f1f3;padding:80px 0 0px}
